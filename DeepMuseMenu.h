...
enum menuTypes { case node, trigger, slider, boxXY, toggle, segment }
/// Menu structure for replacing DeepMuse app's Tr3Thumb* + Panel.*.tr3.h

canvas(type: .node, title: "canvas", icon: "icon.drop.clear", sub: [
    fill(type: .node, title: "fill", icon: "icon.speed.png", sub: [
    ...
    tile(type: .node, title: "tile", icon: "icon.shader.tile.png", sub: [
    ...
    scroll(type: .node, title: "scroll", icon: "icon.cell.scroll.png", sub: [
...
camera(type: .node, title: "camera", icon: "icon.camera.png", sub: [
